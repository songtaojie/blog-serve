...
{
    public partial class InitHxContext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Disable = table.Column<string>(type: "char(1)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "T_ModulePermission",
                columns: table => new
                {
                    Id = table.Column<string>(maxLength: 36, nullable: false),
                    ModuleId = table.Column<string>(maxLength: 36, nullable: true),
                    PermissionId = table.Column<string>(maxLength: 36, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_T_ModulePermission", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(maxLength: 50, nullable: true),
                    IsButton = table.Column<string>(type: "char(1)", nullable: true),
                    IsHide = table.Column<string>(type: "char(1)", nullable: true),
                    IskeepAlive = table.Column<string>(type: "char(1)", nullable: true),
