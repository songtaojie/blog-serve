...
public class SysConfigSeedData : ISqlSugarEntitySeedData<SysConfig>
{
    ...
    public IEnumerable<SysConfig> HasData()
    {
        return new[]
        {
            ...
            new SysConfig{ Id=252885263003806, Name="系统描述", Code="sys_desc", Value="海·星博客系统", SysFlag=YesNoEnum.Y, Remark="系统描述", OrderNo=7, GroupCode="Default", CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
        };
    }
}