...
namespace HxCore.WebApi.Controllers.Admin
{
    ...
    /// 首页横幅控制器
    /// </summary>
    public class BannerManageController : BaseAdminController
    {
        ...
        public BannerManageController(IBannerService service, IBannerQuery query)
        {
            _service = service;
            _query = query;
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<SqlSugarPageModel<BannerManageQueryModel>> GetPageAsync(BannerManageQueryParam param)
        {
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<BannerManageDetailModel> GetAsync(string id)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<bool> AddAsync(BannerManageCreateModel createModel)
        {
