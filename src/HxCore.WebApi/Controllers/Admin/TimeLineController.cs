...
namespace HxCore.WebApi.Controllers.Admin
{
    ...
    public class TimeLineController : BaseAdminController
    {
        ...
        public TimeLineController(ITimeLineService service, ITimeLineQuery query)
        {
            _service = service;
            _query = query;
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<SqlSugarPageModel<TimeLineQueryModel>> GetPageAsync(TimeLineQueryParam param)
        {
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<TimeLineDetailModel> GetAsync(string id)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<bool> AddAsync(TimeLineCreateModel createModel)
        {
