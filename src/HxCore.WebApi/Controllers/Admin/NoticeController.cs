...
namespace HxCore.WebApi.Controllers.Admin
{
    ...
    public class NoticeController : BaseAdminController
    {
        ...
        public NoticeController(INoticeService service, INoticeQuery query)
        {
            _service = service;
            _query = query;
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<SqlSugarPageModel<NoticeQueryModel>> GetPageAsync(NoticeQueryParam param)
        {
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<NoticeDetailModel> GetAsync(string id)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<bool> AddAsync(NoticeCreateModel createModel)
        {
